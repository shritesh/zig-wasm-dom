...
const elementGetAttribute = function (node_id, name_ptr, name_len, result_address_ptr, result_address_len_ptr) {
    ...
    const mem_result_address = new DataView(zigdom.exports.memory.buffer, result_address_ptr, 32 / 8);
    mem_result_address.setUint32(0, ptr, true);

    //write the size of the result array to result_address_ptr_len_ptr
    const mem_result_address_len = new DataView(zigdom.exports.memory.buffer, result_address_len_ptr, 32 / 8);
